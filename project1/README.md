...
#### 2. Głęboka Kopia (Deep Copy)
Zaimplementowaliśmy własny **Konstruktor Kopiujący**. Jest to kluczowe, ponieważ klasa przechowuje wskaźnik. Bez głębokiej kopii, dwa obiekty wskazywałyby na ten sam obszar pamięci, co doprowadziłoby do awarii programu (*Double Free*) przy niszczeniu drugiego obiektu.
